...
public enum ChatConstant {
    ...
    UI_RESPAWN_DEAD("userInterface.respawnDead"),
    UI_RESPAWN_AUTO("userInterface.respawnAuto"),
    UI_RESPAWN_CLICK("userInterface.respawnClick"),
    UI_RESPAWN_SCHEDULE("userInterface.respawnSchedule"),
    ;
